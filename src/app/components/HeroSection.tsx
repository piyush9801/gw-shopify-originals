...
const HOME_HERO_DEFAULTS: TuneConfig = {
  imageIndex: 21,          // 3142
  cropX: 100,
  cropY: 64,
  swooshEnabled: true,
...
export function HeroSection() {
  const [tune, setTune] = useState(() => loadTune("gw-hero-tune", HOME_HERO_DEFAULTS));
  ...
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-end overflow-hidden pb-16 bg-[#E8E6E0]">
      ...
      <TunerPanel title="Home Hero" storageKey="gw-hero-tune" supportsSwoosh={true} tune={tune} onChange={setTune} />
    </section>
  );
}
